...
public class SpendApiClient implements SpendClient {
    ...
    public List<SpendJson> getSpends(String username, CurrencyValues cv, Date from,
                                     Date to) {
        final Response<List<SpendJson>> response;
        try {
            response = spendApi.getSpends(username, cv, from, to)
                    .execute();
    ...
    public void deleteSpend(String username, List<String> ids) {
        ...
        assertEquals(response.code(), HttpStatus.SC_ACCEPTED);
    }
